...
MQW9=/models/unsloth/Qwen3.5-9B-GGUF/Qwen3.5-9B-Q4_K_M.gguf
MQW4=/models/unsloth/Qwen3.5-4B-GGUF/Qwen3.5-4B-Q4_K_M.gguf
MGE4=/models/unsloth/gemma-4-E4B-it-qat-GGUF/gemma-4-E4B-it-qat-UD-Q4_K_XL.gguf
...
for img in Test.png Test3.jpg; do
  ...
  run "qw4b_f16_$s"  $MQW4 /models/unsloth/Qwen3.5-4B-GGUF/mmproj-F16.gguf       $img no
  run "qw9b_bf16_$s" $MQW9 /models/unsloth/Qwen3.5-9B-GGUF/mmproj-BF16.gguf      $img no
  run "qw9b_f16_$s"  $MQW9 /models/unsloth/Qwen3.5-9B-GGUF/mmproj-F16.gguf       $img no
  run "ge4b_f16_$s"  $MGE4 /models/unsloth/gemma-4-E4B-it-qat-GGUF/mmproj-F16.gguf $img jinja
done
